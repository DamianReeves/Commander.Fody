...
using System.Linq;
using Commander.Samples.WP8.Resources;

namespace Commander.Samples.WP8.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        [Commander.OnCommand("AddItemCommand")]
        public void AddItem()
        {
        }

        [Commander.OnCommandCanExecute("RemoveItemCommand")]
        public bool CanRemoveItem(object parameter)
        {
            var item = parameter as ItemViewModel;
            return item != null && (item.Id%2) == 0;
        }

        [Commander.OnCommand("RemoveItemCommand")]
